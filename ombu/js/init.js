// Developer: O'Neal Ombu - https://www.onealombu.xyz/
...
(function ($) {
  ...
  var OmbuObject = {
    ...
    anchor: function () {
      var a = $("section a[href^='#'],.ombu_intro a[href^='#']");
      a.on("click", function () {
    ...
    owl: function () {
      $(".ombu_portfolio_slider .owl-carousel").each(function () {
        var e = $(this);
        var p = e.closest(".ombu_portfolio_slider");
        e.owlCarousel({
          loop: true,
          margin: 30,
          nav: false,
        ...
        p.find(".ombu_prevnext .next a").click(function () {
          e.trigger("next.owl.carousel");
          return false;
        });
        p.find(".ombu_prevnext .prev a").click(function () {
          e.trigger("prev.owl.carousel");
          return false;
        });
      });

      $(".ombu_testi_slider .owl-carousel").each(function () {
        var e = $(this);
        var p = e.closest(".ombu_testi_slider");
        e.owlCarousel({
          loop: true,
          margin: 30,
          nav: false,
      ...
      $(".ombu_news_slider .owl-carousel").each(function () {
        var e = $(this);
        var p = e.closest(".ombu_news_slider");
        e.owlCarousel({
          loop: true,
          margin: 30,
          nav: false,
    ...
    modal: function () {
      var self = this;
      var modalBox = $(".ombu_modalbox");
      var item = $(".modal_item");
      var closePopup = modalBox.find(".close");
      var prevNext = modalBox.find(".ombu_prevnext");
    ...
    hashtag: function () {
      var self = this;
      var ccc = $(".ombu_topbar .menu .ccc");
      var element = $(".ombu_topbar .menu .current a");
      $(".ombu_topbar .menu a").on("mouseenter", function () {
        var e = $(this);
        self.currentLink(ccc, e);
      });
      $(".ombu_topbar .menu").on("mouseleave", function () {
        element = $(".ombu_topbar .menu .current a");
    ...
    currentLink: function (ccc, e) {
      ...
      var menuleft = $(".ombu_topbar .menu").offset().left;
